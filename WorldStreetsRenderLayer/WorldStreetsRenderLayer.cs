...
namespace ThinkGeo.MapSuite
{
    ...
    public partial class WorldStreetsRenderLayer : Layer
    {
        ...
        public WorldStreetsRenderLayer(string connectionString, string schemaName, string featureIdColumnName, string geometryColumnName, int srid)
        {
            ...
            this.srid = srid;
            iconPath = AppDomain.CurrentDomain.BaseDirectory + "Icons\\";
        }
        ...
        public void DrawBackground(GeoCanvas canvas, Collection<SimpleCandidate> labelsInAllLayers)
        {
            DrawBackgroundCore(canvas, labelsInAllLayers);
        }

        protected virtual void DrawBackgroundCore(GeoCanvas canvas, Collection<SimpleCandidate> labelsInAllLayers)
        {
        ...
        private CompositeStyle GetRoadLevel13Styles()
        {
            ...
            ValueStyle label = new ValueStyle("highway", new Collection<ValueItem>()
            {
                new ValueItem("motorway", new Collection<Style>(){ GetGeneralPurposeTextStyle("name", motorwayFontSize), GetGeneralPurposeTextStyle("name:en", motorwayFontSize), GetMotorwayRoadSheildLabelTextStyle("ref", motorwayFontSize) }),
                new ValueItem("trunk", new Collection<Style>(){ GetGeneralPurposeTextStyle("name", trunkFontSize), GetGeneralPurposeTextStyle("name:en", trunkFontSize), GetTrunkRoadSheildLabelTextStyle("ref", trunkFontSize) }),
                new ValueItem("primary", new Collection<Style>(){ GetGeneralPurposeTextStyle("name", primaryFontSize), GetGeneralPurposeTextStyle("name:en", primaryFontSize), GetPrimaryRoadSheildLabelTextStyle("ref", primaryFontSize) })
            });
        ...
        private CompositeStyle GetRoadLevel15Styles()
        {
            ...
            ValueStyle label = new ValueStyle("highway", new Collection<ValueItem>()
            {
                ...
                new ValueItem("trunk", new Collection<Style>(){ GetGeneralPurposeTextStyle("name", trunkFontSize), GetGeneralPurposeTextStyle("name:en", trunkFontSize), GetTrunkRoadSheildLabelTextStyle("ref", trunkFontSize) }),
                new ValueItem("primary", new Collection<Style>(){ GetGeneralPurposeTextStyle("name", primaryFontSize), GetGeneralPurposeTextStyle("name:en", primaryFontSize), GetPrimaryRoadSheildLabelTextStyle("ref", primaryFontSize) }),
                new ValueItem("secondary", new Collection<Style>(){ GetGeneralPurposeTextStyle("name", secondaryFontSize), GetGeneralPurposeTextStyle("name:en", secondaryFontSize) }),
                new ValueItem("tertiary", new Collection<Style>(){ GetGeneralPurposeTextStyle("name", tertiaryFontSize), GetGeneralPurposeTextStyle("name:en", tertiaryFontSize) })
            });
        ...
        private CompositeStyle GetRoadLevel16Styles()
        {
            ...
            ValueStyle label = new ValueStyle("highway", new Collection<ValueItem>()
            {
                ...
                new ValueItem("secondary", new Collection<Style>(){ GetGeneralPurposeTextStyle("name", secondaryFontSize), GetGeneralPurposeTextStyle("name:en", secondaryFontSize) }),
                new ValueItem("tertiary", new Collection<Style>(){ GetGeneralPurposeTextStyle("name", tertiaryFontSize), GetGeneralPurposeTextStyle("name:en", tertiaryFontSize) }),
                new ValueItem("residential", new Collection<Style>(){ GetGeneralPurposeTextStyle("name", residentialFontSize), GetGeneralPurposeTextStyle("name:en", residentialFontSize) }),
                new ValueItem("unclassified", new Collection<Style>(){ GetGeneralPurposeTextStyle("name", unclassifiedFontSize), GetGeneralPurposeTextStyle("name:en", unclassifiedFontSize) }),
                new ValueItem("road", new Collection<Style>(){ GetGeneralPurposeTextStyle("name", roadFontSize), GetGeneralPurposeTextStyle("name:en", roadFontSize) }),
                new ValueItem("living_street", new Collection<Style>(){ GetGeneralPurposeTextStyle("name", livingStreetFontSize), GetGeneralPurposeTextStyle("name:en", livingStreetFontSize) }),
            });
