...
namespace ThinkGeo.MapSuite
{
    ...
    public class WorldImageryRenderLayer : WorldStreetsRenderLayer
    {
        ...
        protected override void OpenCore()
        {
            ...
            Collection<string> keys = Layers.GetKeys();
            ...
            if (Srid != 4326)
            {
                countriesOutlineLayer.FeatureSource.Projection = new Proj4Projection(4326, Srid);
        ...
        protected override PointStyle GetImagePointStyle(string filename)
        {
            ...
            background.CustomPointStyles.Add(new PointStyle() { PointType = PointType.Bitmap, Image = new GeoImage(AppDomain.CurrentDomain.BaseDirectory + "Icons\\" + filename), DrawingLevel = DrawingLevel.LabelLevel });
        ...
        {
            return new LineStyle(new GeoPen(new GeoColor(125, 225, 183, 122), width) { StartCap = DrawingLineCap.Round, EndCap = DrawingLineCap.Round });
        }

        protected override LineStyle GetMotorwayFillLineStyle(float width)
        {
            return new LineStyle(new GeoPen(new GeoColor(125, 247, 195, 128), width) { StartCap = DrawingLineCap.Round, EndCap = DrawingLineCap.Round });
        }

        protected override LineStyle GetTrunkOutlineLineStyle(float width)
        {
            return new LineStyle(new GeoPen(new GeoColor(125, 225, 205, 168), width) { StartCap = DrawingLineCap.Round, EndCap = DrawingLineCap.Round });
        }

        protected override LineStyle GetTrunkFillLineStyle(float width)
        {
            return new LineStyle(new GeoPen(new GeoColor(125, 245, 231, 202), width) { StartCap = DrawingLineCap.Round, EndCap = DrawingLineCap.Round });
        }

        protected override LineStyle GetPrimaryOutlineLineStyle(float width)
        {
            return new LineStyle(new GeoPen(new GeoColor(125, 240, 234, 208), width) { StartCap = DrawingLineCap.Round, EndCap = DrawingLineCap.Round });
        }

        protected override LineStyle GetPrimaryFillLineStyle(float width)
        {
            return new LineStyle(new GeoPen(new GeoColor(125, 250, 246, 225), width) { StartCap = DrawingLineCap.Round, EndCap = DrawingLineCap.Round });
        }

        protected override LineStyle GetRoadOutlineLineStyle(float width)
        {
            return new LineStyle(new GeoPen(new GeoColor(100, 225, 225, 225), width - 0.9f) { StartCap = DrawingLineCap.Round, EndCap = DrawingLineCap.Round });
        }

        protected override LineStyle GetRoadFillLineStyle(float width)
        {
            return new LineStyle(new GeoPen(new GeoColor(100, 255, 255, 255), width - 0.9f) { StartCap = DrawingLineCap.Round, EndCap = DrawingLineCap.Round });
        }

        protected override LineStyle GetMotorwayLinkOutlineLineStyle(float width)
        {
            return new LineStyle(new GeoPen(new GeoColor(125, 225, 182, 120), width) { StartCap = DrawingLineCap.Round, EndCap = DrawingLineCap.Round });
        }

        protected override LineStyle GetMotorwayLinkFillLineStyle(float width)
        {
            return new LineStyle(new GeoPen(new GeoColor(125, 247, 221, 185), width) { StartCap = DrawingLineCap.Round, EndCap = DrawingLineCap.Round });
        }

        protected override LineStyle GetTrunkLinkOutlineLineStyle(float width)
        {
            return new LineStyle(new GeoPen(new GeoColor(125, 226, 208, 172), width) { StartCap = DrawingLineCap.Round, EndCap = DrawingLineCap.Round });
        }

        protected override LineStyle GetTrunkLinkFillLineStyle(float width)
        {
            return new LineStyle(new GeoPen(new GeoColor(125, 250, 242, 225), width) { StartCap = DrawingLineCap.Round, EndCap = DrawingLineCap.Round });
        }

        protected override LineStyle GetPrimaryLinkOutlineLineStyle(float width)
        {
            return new LineStyle(new GeoPen(new GeoColor(125, 204, 204, 204), width) { StartCap = DrawingLineCap.Round, EndCap = DrawingLineCap.Round });
        }
        ...
        {
            return new LineStyle(new GeoPen(new GeoColor(125, 240, 239, 238), width) { StartCap = DrawingLineCap.Round, EndCap = DrawingLineCap.Round });
        }
    }
}
